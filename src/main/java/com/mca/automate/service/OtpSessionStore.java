...
public class OtpSessionStore {
    ...
    private final Map<String, String> emailCookies = new ConcurrentHashMap<>();
    private final Map<String, String> emailMobile = new ConcurrentHashMap<>();

    public void remember(String email, String cookie, String mobile, String sblUserId) {
        if (email != null && !email.isBlank()) {
            this.emailCookies.put(email.trim().toLowerCase(), cookie);
            if (mobile != null && !mobile.isBlank()) {
                this.emailMobile.put(email.trim().toLowerCase(), mobile);
            }
        }
    ...
    public String getCookieByEmail(String email) {
        if (email == null || email.isBlank()) {
            return "";
        }
        String cookie = this.emailCookies.get(email.trim().toLowerCase());
    ...
    public String getMobileByEmail(String email) {
        ...
        String mobile = this.emailMobile.get(email.trim().toLowerCase());
